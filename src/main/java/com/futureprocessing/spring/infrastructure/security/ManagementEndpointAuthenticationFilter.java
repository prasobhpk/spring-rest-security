...
@Component("managementEndpointAuthenticationFilter")
public class ManagementEndpointAuthenticationFilter extends GenericFilterBean {
    ...
    @Autowired
    public ManagementEndpointAuthenticationFilter(@Qualifier("authenticationManager")AuthenticationManager authenticationManager) {
